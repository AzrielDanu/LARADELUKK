                    ...
                    <ul id="sidebarnav">
                        ...
                        @if (Auth::check())
                            @if (Auth::user()->role == 'admin')
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('admin.PurchaseHome') }}" aria-expanded="false">
                            ...
                            @else
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('employee.PurchaseIndex') }}" aria-expanded="false">
                                        <i class="mdi mdi-cart"></i>
                                        <span class="hide-menu">Purchase</span>
                                    </a>
                                </li>
